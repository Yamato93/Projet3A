...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<div role="tabpanel">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Add Route</a></li>
		</ul>
						...
						<tbody>
							...
							foreach($list as $key=>$value)
							{
								...
								if($_SESSION['User']->ADM_LVL > 3)
								{
									?>
										<td>
											<a id="edit" data-toggle="modal" data-target="#myModal<?php echo $value->ROUTE_ID; ?>"><span class="glyphicon glyphicon-pencil"></span></a> /
											<a id="delete" href="index.php?module=index&action=deladmin&del=<?php echo $value->ROUTE_ID; ?>"><span class="glyphicon glyphicon-remove"></span></a>
										</td>
								</tr>
									<?php
								}
		    ...
		    <div role="tabpanel" class="tab-pane" id="profile">
		    	<div class="col-md-4">
				    <form role="form" name="add_admin_form" action="index.php?module=index&action=index" method="post">
						...
						<div class="form-group">
							<label for="Name">Parcours Title</label>
							<input type="text" class="form-control" id="name" name="name" placeholder="Enter name">
						</div>
						<div class="form-group">
						    <label for="exampleInputEmail1">Parcous Description</label>
