<?php
if (isset($_POST['type'])=='login' && isset($_POST['mail']) && isset($_POST['password'])) {
...
if (isset($_POST['type'])=='register' && isset($_POST['mail']) && isset($_POST['password']) && isset($_POST['passwordconfirm'])){
